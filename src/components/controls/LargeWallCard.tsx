...
export const LargeWallCard: React.FC<LargeWallCardProps> = (
  props: LargeWallCardProps
) => {
  const {
    wallImageSrc,
    status,
      ...
      >
        ...
        >
          <CardDetails>
            ...
            <SqftWrapper style={{ paddingRight: '10px' }}>
              <Icon
                src={cloudflareImage(
